...
typedef enum : int {
	...
	ST_FPLLL=ST_JP*2,
	ST_FPLLL_GREEDY=ST_FPLLL*2,
	
	ST_SNAP_TYPES_MASK=ST_CF|ST_FX|ST_FL|ST_JP|ST_FPLLL|ST_FPLLL_GREEDY,
	...
	ST_AUTO_FPLLL_GREEDY=ST_AUTO_FPLLL*2, //add fplll-greedy to auto snapping
	ST_AUTO=ST_AUTO_FPLLL*2, //select snapping that produces the smallest denominators
	ST_AUTO_ALL=ST_AUTO|ST_AUTO_CF|ST_AUTO_FX|ST_AUTO_JP|ST_AUTO_FPLLL|ST_AUTO_FPLLL_GREEDY, //try all snappings and use the best one
	...
	ST__INTERNAL_NUMBER_OF_SNAPPING_TYPES=6, //this effecivly defines the shift to get from ST_* to ST_AUTO_*
